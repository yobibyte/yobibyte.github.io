from compressor import PaperDB
...
if __name__ == '__main__':
    ...
    header = f"""
            ...
            <h1>arxiv compressed, {latest_date}</h1>
            <p>This page contains one-sentence summaries of cs.AI/ML/CV/CL papers announced on {latest_date} generated by the compressor, my personal LLM-based project.</p>
    """
